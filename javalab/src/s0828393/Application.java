...
public class Application extends javax.swing.JFrame {
	...
	private JLabel unitByteSec;
	private JLabel unitms;
			...
			getContentPane().setLayout(null);
			{
				...
				tp.setBounds(0, 11, 581, 414);
				{
					...
					}
					{
						...
						jPanel2.setBounds(374, 158, 202, 166);
						...
						jPanel2.add(getUnitms());
						jPanel2.add(getUnitByteSec());
					}
					{
						jPanel3 = new JPanel();
	...
	private void btnStartActionPerformed(ActionEvent evt) {
		...
		try {
			client.sendFile(fileName, txtServerIP.getText(),Integer.parseInt( txtPort.getText()),Integer.parseInt( txtPacketSize.getText()), txtInfo);
	...
	private JTextField getLblStartTime() {
		if(lblStartTime == null) {
			...
			lblStartTime.setBounds(92, 26, 77, 20);
		}
		return lblStartTime;
	}
	...
	private JTextField getLblStopTime() {
		if(lblStopTime == null) {
			...
			lblStopTime.setBounds(93, 56, 75, 20);
		}
		return lblStopTime;
	}
	...
	private JTextField getLblTTime() {
		if(lblTTime == null) {
			...
			lblTTime.setBounds(92, 87, 74, 20);
		}
		return lblTTime;
	}
	...
	private JTextField getLblSpeed() {
		if(lblSpeed == null) {
			...
			lblSpeed.setBounds(92, 119, 75, 20);
		}
		return lblSpeed;
	}
	...
	private void jButton1ActionPerformed(ActionEvent evt) {
		...
		try {
			server.startServer(Integer.parseInt(jTextField2.getText().toString()), 1024, jTextArea1);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public JTextArea getJTextArea1() {
		if(jTextArea1 == null) {
			...
			jTextArea1.setPreferredSize(new java.awt.Dimension(541, 184));
		}
		return jTextArea1;
	}
	...
	private JLabel getUnitms() {
		if(unitms == null) {
			unitms = new JLabel();
			unitms.setText("ms");
			unitms.setBounds(169, 89, 25, 16);
		}
		return unitms;
	}
	
	private JLabel getUnitByteSec() {
		if(unitByteSec == null) {
			unitByteSec = new JLabel();
			unitByteSec.setText("B/s");
			unitByteSec.setBounds(169, 121, 25, 16);
		}
		return unitByteSec;
	}
