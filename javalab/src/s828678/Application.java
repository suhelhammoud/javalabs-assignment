...
public class Application extends javax.swing.JFrame {
	...
	private JPanel getJPanel5() {
		if(jPanel5 == null) {
			...
			jPanel5.setLayout(null);
			jPanel5.setBorder(BorderFactory.createTitledBorder(null, "Server IP/PORT", TitledBorder.LEADING, TitledBorder.TOP));
			jPanel5.setForeground(new java.awt.Color(0,128,128));
	...
	private JButton getJButton1() {
		if(jButton1 == null) {
			...
			jButton1.setBounds(321, 25, 194, 34);
	...
	private JButton getJButton2() {
		if(jButton2 == null) {
			...
			jButton2.setBounds(321, 86, 194, 33);
